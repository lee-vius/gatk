    ...
    public void testWriteTwoFiles() throws IOException {
        ...
        final List<LinkedHashMap<String, String>> gt2 = Arrays.asList(
            FuncotatorUtils.createLinkedHashMapFromLists(fields2,
                    Arrays.asList("FOO_VALUE0", interval.getContig(), String.valueOf(interval.getEnd()),
                            "VAL1", "VAL2", String.valueOf(interval.getStart()))),
            FuncotatorUtils.createLinkedHashMapFromLists(fields2,
                    Arrays.asList("FOO_VALUE1", interval.getContig(), String.valueOf(interval.getEnd()),
                            "VAL1", "VAL2", String.valueOf(interval.getStart())))
        );
